...
namespace XamarinForms.ListViewApp
{
    public partial class MainPage : ContentPage
    {
        ...
        void OnListView_ItemSelected(object sender, SelectedItemChangedEventArgs e)
        {
            Monkey selectedItem = e.SelectedItem as Monkey;
        }

        void OnListView_ItemTapped(object sender, ItemTappedEventArgs e)
        {
